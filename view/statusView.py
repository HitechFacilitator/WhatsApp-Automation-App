...
def show_status_interface(app, controller):
    ...
    # statusMsg_entry = ctk.CTkEntry(creation_frame, width=300,placeholder_text="The recipient Number or it WhatsApp Name")
    ...
    # Card Section
    card_frame = ctk.CTkFrame(status_frame, fg_color="#DCF8C6", corner_radius=15, width=800, height=400)  # Light green background
    ...
    # Table/List for Status
    status_table = ctk.CTkFrame(card_frame, fg_color="white", corner_radius=10)
    status_table.pack(fill="both", expand=True, padx=10, pady=10)
